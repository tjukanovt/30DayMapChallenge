# Statistics
Every year the challenge gathers thousands of mappers around the globe. As the challenge has spread across various platforms, gathering statistics has proven to be nearly impossible. The challenge has been running since 2019 and the total number of maps created is more than 50,000.
